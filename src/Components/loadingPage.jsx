  ...
  return Array.from({ length: count }).map((_, i) => {
    ...
    return (
      <motion.div
        ...
        className="absolute rounded-full bg-[#3B2A1A] opacity-30 mix-blend-difference"
      />
    );
  });
};
...
const LoadingPage = () => {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          className="fixed inset-0 z-[999] bg-[#F3EEE7] flex items-center justify-center overflow-hidden"
          initial={{ opacity: 1 }}
